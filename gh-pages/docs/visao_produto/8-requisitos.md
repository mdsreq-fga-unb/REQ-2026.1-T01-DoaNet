...
- <a id="rf06"></a>**RF06:** Filtrar o feed por tipo de publicação [CP3 - Feed de Comunicação]

- <a id="rf07"></a>**RF07:** Buscar publicação no feed por título [CP3 - Feed de Comunicação]
