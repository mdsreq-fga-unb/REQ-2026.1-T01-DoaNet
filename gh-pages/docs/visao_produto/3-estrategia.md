...
- **Processo:** Scrum + Kanban

---

## 3.2 Quadro Comparativo

| Característica | Scrum + Kanban | OpenUP |
|--------------|--------------|-------------|
...
| **Estrutura de processos** | Baseado em sprints curtos (2-4 semanas) e um fluxo contínuo de trabalho, mapeado dentro do quadro do Kanban, com entregas frequentes e flexibilidade para mudanças no backlog. | Fase inicial de planejamento (Inception), seguida por uma fase de construção (Construction) e, finalmente, transição (Transition). Menos formal que o RUP. |
...
| **Qualidade Técnica** | Foco contínuo em qualidade, com práticas como integração contínua, refatoração e feedback rápido, garantindo alta qualidade a cada entrega. | Garantida pela evolução da arquitetura e revisões incrementais ao longo do ciclo de vida do projeto. |
| **Práticas de Desenvolvimento** | Foco em fluxo de trabalho, limitação de tarefas em progresso (WIP), melhorias contínuas no processo e práticas ágeis (como pair programming e integração contínua). | Foco em modelagem e arquitetura de software com práticas de controle de progresso e validação constante ao longo do processo. |
...
| **Controle de qualidade** | Controle contínuo de qualidade integrado ao processo de desenvolvimento com práticas como a limitação do WIP, integração contínua e feedback constante. | Validação contínua do sistema com revisões incrementais e arquitetura em constante avaliação. |
