# Sprint 2 — Engenharia de Software

[← Voltar ao Objetivo Geral](objetivo-geral.md)

## Descrição da Entrega

Implementação das funcionalidades centrais da plataforma DoaNet, com foco na criação, edição e deleção de postagens normais (sem evento atrelado), sobre a stack consolidada após o pivoteamento (FastAPI + MongoDB + Flutter + Streamlit).
