...
**Rota de acesso (Streamlit — painel admin):** [painel-adm-lkhp.onrender.com](https://painel-adm-lkhp.onrender.com/) → seção **📋 Publicações** → aba **➕ Nova publicação**
...
**Rota de acesso (Streamlit — painel admin):** [painel-adm-lkhp.onrender.com](https://painel-adm-lkhp.onrender.com/) → seção **📋 Publicações** → aba **🗂️ Gerenciar** → **🗑️ Remover**
...
**Rota de acesso (Streamlit — painel admin):** [painel-adm-lkhp.onrender.com](https://painel-adm-lkhp.onrender.com/) → seção **📋 Publicações** → aba **🗂️ Gerenciar** → **💾 Salvar alterações**
