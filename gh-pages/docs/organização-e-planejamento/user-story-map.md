...
(function(){
  ...
  var GROUPS=[
    ...
    {id:'G2',label:'Feed de Post das Organizacoes',persona:'Usuario / Admin da Organizacao',
     ...
     tasks:[
       ...
       {label:'Filtrar por tipo',us:['US06']},
       {label:'Buscar por titulo',us:['US07']},
  ...
  var LABEL={
    ...
    T_G2_0:'Visualizar publicações',T_G2_1:'Filtrar por tipo',
    T_G2_2:'Buscar por título',T_G2_3:'Gerenciar publicações',
  ...
  var UI={
    ...
    US03:{rf:'RF03',sprint:6,desc:'Visualizar descrição da ONG (fora do MVP)',link:'../planejamento/observacoes-gerais/#us03',st:'vm',persona:'Usuário',cl:['Descrição','da ONG']},
    ...
    US05:{rf:'RF05',sprint:6,desc:'Contactar a organização (fora do MVP)',link:'../planejamento/observacoes-gerais/#us05',st:'vm',persona:'Usuário',cl:['Contactar','organização']},
    US06:{rf:'RF06',sprint:5,desc:'Filtrar o feed por tipo de publicação',link:'../planejamento/sprint-5/user-stories/#us06',st:'vd',persona:'Usuário',cl:['Filtrar feed','por tipo']},
    US07:{rf:'RF07',sprint:5,desc:'Buscar publicação no feed por título',link:'../planejamento/sprint-5/user-stories/#us07',st:'vd',persona:'Usuário',cl:['Buscar feed','por título']},
