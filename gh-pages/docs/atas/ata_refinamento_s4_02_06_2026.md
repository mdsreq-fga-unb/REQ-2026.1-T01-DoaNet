# Refinamento do User Story Map — Sprint 4
...
- Revisão do progresso das histórias de voluntariado (US04, US08, US20, US21, US22)
- Refinamento do User Story Map com foco na integração do painel admin com o módulo de voluntariado
- Alinhamento sobre o débito técnico identificado no formulário de inscrição (US08)
- Distribuição de tarefas para a semana final da sprint e definição de critérios de entrega
...
| Expansão do painel Streamlit com as telas de gerenciamento de feed e voluntariado | João Leles | 09/06/2026 |
