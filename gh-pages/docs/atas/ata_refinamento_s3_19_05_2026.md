# Refinamento do User Story Map — Sprint 3
...
- Revisão do progresso das histórias de usuário da Sprint 3 (US09, US11 e extensão de US17 para eventos)
- Refinamento do User Story Map com ajustes baseados no feedback da revisão da Sprint 2
- Detalhamento das tarefas de backend (FastAPI) e frontend (Flutter) para a semana final
- Alinhamento sobre o progresso do módulo de autenticação admin (US11) e inscrição em eventos (US09)
