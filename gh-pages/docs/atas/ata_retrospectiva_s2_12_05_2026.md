...
1. Coletar as percepções individuais dos membros sobre o andamento da Sprint 2.
2. Refletir sobre o impacto do pivoteamento no fluxo de trabalho da equipe.
3. Identificar pontos de melhoria e encaminhamentos para a Sprint 3.
...
| :--- | :--- | :--- |
| Realizar provas de conceito para novos módulos antes de iniciar a implementação completa | Toda a equipe | Sprint 3 |
| Revisar o Story Map com o cliente ao início de cada sprint | Letícia Vitória | Sprint 3 |
